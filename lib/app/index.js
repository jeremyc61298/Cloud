...
exports.app.use(express_1.default.static(config.staticDirectory));
exports.app.use(config.cloudDirectoryUserView, routes_1.router);
// Error handling
exports.app.use(common_1.defaultNotFound);
exports.app.use(common_1.uploadTooLarge);
exports.app.use(common_1.defaultInternalError);
